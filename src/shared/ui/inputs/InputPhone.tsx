...
export function InputPhone({
  ...
  return (
    <div className={`relative ${containerStyle}`}>
      ...
      <IoMdPhonePortrait className="pointer-events-none absolute left-4 top-1/2 z-10 -translate-y-1/2 text-[20px] text-gray-500 transition-colors duration-300 peer-focus:text-blue-600" />
